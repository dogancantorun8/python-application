# -*- coding: utf-8 -*-
"""
Created on Sat Mar 20 20:28:15 2021

@author: Doğancan Torun
"""
#bu örnek te iki csv arasında bağlantı kuracağım:listboxta ile tıklayınca o ilin ilcelerini pandas ile görütüleyebiliyoruz 
...
class MainWindow(QWidget):
    ...
    def listWidgetDoubleClickHandler(self, lwi):
        QMessageBox.information(None, 'Test', lwi.text())
